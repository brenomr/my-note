...
public class NoteItemsRecyclerViews extends RecyclerView.Adapter {
    ...
    public NoteItemsRecyclerViews(List<NoteModel> noteModels, NoteClickListener noteClickListener){
    ...
    public class NoteViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView txtNote, txtCreateTime;
